...
public interface LaunchEntryPersistence extends BasePersistence<LaunchEntry> {
	 ...
	 * @return the matching launch entry, or <code>null</code> if a matching launch entry could not be found
	 */
	public default LaunchEntry fetchByC_C_C(
		long classNameId, long classPK, String classVersion) {
	 ...
	 * @return the matching launch entry, or <code>null</code> if a matching launch entry could not be found
	 */
	public default LaunchEntry fetchByERC_C(
		String externalReferenceCode, long companyId) {
	 ...
	 */
	public default java.util.List<LaunchEntry> findByUuid(String uuid) {
		return findByUuid(
	 ...
	 */
	public default java.util.List<LaunchEntry> findByUuid(
		String uuid, int start, int end) {
	 ...
	 * @return the matching launch entries
	 */
	public default java.util.List<LaunchEntry> findByUuid_C(
		String uuid, long companyId) {
	 ...
	 * @return the matching launch entries
	 */
	public default java.util.List<LaunchEntry> findByLaunchSetId(
		long launchSetId) {

		return findByLaunchSetId(
			launchSetId, com.liferay.portal.kernel.dao.orm.QueryUtil.ALL_POS,
			com.liferay.portal.kernel.dao.orm.QueryUtil.ALL_POS, null, true);
	}
	...
	public default java.util.List<LaunchEntry> findByLaunchSetId(
		...
		return findByLaunchSetId(launchSetId, start, end, null, true);
	}
...
// LIFERAY-SERVICE-BUILDER-HASH:1160149164