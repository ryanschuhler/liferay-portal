...
import {
	IMyAccountApollo,
	hasAdminUserAccount,
} from '~/features/project/containers/ActivationKeysTable/utils/hasAdminUserAccount';
...
const ActivationKeysTableHeader = ({
	...
	const isAbleToDownloadAggregateKeys = useMemo(() => {
		if (!activationKeysByStatusPaginatedChecked.length) {
			return true;
		}
