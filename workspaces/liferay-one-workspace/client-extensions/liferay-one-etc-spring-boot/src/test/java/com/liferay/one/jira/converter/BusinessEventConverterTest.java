...
public class BusinessEventConverterTest {
	...
	public void testToBusinessEvent() throws Exception {
		...
		// Exercises the inbound Jira data contract: a business-event
		// attributes payload maps onto the BusinessEvent model, with the
		// account and author supplied by the caller.
