...
// Plan coverage (route wiring): [ROUTE-ATTACHMENTS-ERC-TICKETATTACHMENTERC]
// [ROUTE-ATTACHMENTS-ID-TICKETATTACHMENTID] [ROUTE-ATTACHMENTS-NEW]
// [ROUTE-ATTACHMENTS-NEW-TICKETID] [ROUTE-ATTACHMENTS-TICKETID]
