...
import FormLayoutFooter from '~/pages/BusinessEvents/BusinessEventsAdd/components/FormLayoutFooter/FormLayoutFooter';
import FormLayoutHeader from '~/pages/BusinessEvents/BusinessEventsAdd/components/FormLayoutHeader/FormLayoutHeader';
...
interface IProps {
	...
	className?: string;
	footerProps?: React.ComponentProps<typeof FormLayoutFooter>;
	headerProps?: {
