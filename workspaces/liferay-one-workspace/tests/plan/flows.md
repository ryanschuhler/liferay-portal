...
| FLOW-LICENSE-REVOCATION | License key revocation flips status and notifies the account | integration | P1 | planned | spec:flow#license-revocation |
...
| FLOW-TRIAL-PROVISIONING | Trial provisioning: request → cloud instance provisioned → status Active | integration | P0 | planned | spec:flow#trial-provisioning |
| FLOW-TRIAL-EXPIRY | Trial expiry: decommission cloud instance and mark expired | integration | P1 | planned | spec:flow#trial-expiry |
